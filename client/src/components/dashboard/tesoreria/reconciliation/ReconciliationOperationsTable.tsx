...
export const ReconciliationOperationsTable: React.FC<Props> = ({
  ...
  return (
    <div className="flex-1 flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm">
      <div className="lg:hidden flex-1 overflow-y-auto p-4 space-y-3 border-b border-gray-100">
        {loading && (
      ...
      <div className="hidden lg:block lg:flex-1 overflow-auto">
        <table className="w-full lg:min-w-[720px]">
